...
class PaymentQuery {
	 ...
	 * @return PaymentQuery - returns this in order to support fluent syntax.
	 */
	public function set_on_or_before(string $on_or_before) : PaymentQuery {
	 ...
	 * @return PaymentQuery - returns this in order to support fluent syntax.
	 */
	public function set_on_or_after(string $on_or_after) : PaymentQuery {
	 ...
	 * @return PaymentQuery - returns this in order to support fluent syntax.
	 */
	public function set_user_id(int $user_id) : PaymentQuery {
